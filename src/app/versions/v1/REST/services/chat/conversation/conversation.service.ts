...
import { ConversationRepository } from '@app/versions/v1/REST/repositories/conversation.repository';
...
import { ConversationCreatedEvent } from '@app/versions/v1/REST/entities/conversation-created.event';
import { EventEmitter2 } from '@nestjs/event-emitter';
import { ConversationAttachmentService } from '@app/versions/v1/REST/services/chat/conversation-attachment/conversation-attachment.service';
import { deleteFile } from '@libs/helpers/file-processor';
import mongoose from 'mongoose';
import { DeleteConversationDto } from '@app/versions/v1/REST/dto/chat/conversation/delete-conversation.dto';
import { TQuery } from '@libs/database/abstract.repository';
import { ConversationsFetchEvent } from '@app/versions/v1/REST/events/chat/conversation/conversations-fetch.event';
import { ConversationDeletedEvent } from "@app/versions/v1/REST/events/chat/conversation/conversation-deleted.event";
